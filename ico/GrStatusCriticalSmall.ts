...
/**
 * StatusCriticalSmall icon from Grommet-Icons
 * @module
 */
export function GrStatusCriticalSmall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default GrStatusCriticalSmall;
